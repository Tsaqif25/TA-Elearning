                        ...
                        <div class="text-center">
                            @if ($user->gambar == null)
                                <img src="/asset/icons/profile-women.svg" class="image-previewer image-class rounded-circle"
                                    width="150" alt="">
                            @else
                                <img src="{{ asset('/storage/file/img-upload/' . $user->gambar) }}" alt="placeholder"
                        ...
                        @foreach ($mapelKelas as $mapelKelasItem)
                            <div class="card w-100 my-4" style="width: 18rem;">
                                @if ($mapelKelasItem['mapel']->gambar != null)
                                    <img src="{{ url('storage/file/img-upload/' . $mapelKelasItem['mapel']->gambar) }}"
                                ...
                                <div class="col-md-4">
                                    @if ($mapelKelasItem['mapel']->gambar != null)
                                        <div class="card-img-full"
                                            style="background-image: url('{{ asset('storage/file/img-upload/' . $mapelKelasItem['mapel']->gambar) }}')">
                                        </div>
                                    @else
                                        <div class="card-img-full"
