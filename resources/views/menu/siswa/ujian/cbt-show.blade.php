...
<div class="w-full bg-gray-100 py-8 font-poppins">
        ...
        <div class="md:col-span-2">
            <div class="bg-white shadow rounded-xl p-6">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <span class="px-3 py-1.5 text-sm bg-blue-500 text-white rounded-full">
                        ⏱ Timer Disini
                    </span>
                </div>
    ...
    @foreach ([1,2,3,4,5] as $num)
        @php
            $field = 'option_' . $num;  // sesuai database kamu
    ...
    @endforeach
                ...
                <div class="flex justify-between mt-8">
                    ...
                    @else
                        <a href="{{ route('ujian.learning.finished', $attempt->id) }}"
                           class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                            Selesai
                        </a>
                    @endif
        ...
        <div>
            <div class="bg-white shadow rounded-xl p-6">
                ...
                <div class="mt-6">
                {{-- <a href="{{ route('ujian.finish', $attempt->id) }}"
