  ...
  <div class="max-w-[1200px] w-full mx-auto px-4 sm:px-6 lg:px-10 mt-8 mb-16">
    ...
    <div class="bg-[#2B82FE] text-white rounded-2xl p-6 sm:p-8 mb-8 shadow-sm">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex flex-wrap gap-2">
          <button class="bg-white text-[#2B82FE] px-5 py-2 rounded-full font-semibold text-sm shadow hover:bg-blue-50 transition">
            <i class="fa-solid fa-book-open"></i> Buka Materi
          </button>
          <button class="bg-white text-[#2B82FE] px-5 py-2 rounded-full font-semibold text-sm shadow hover:bg-blue-50 transition">
    ...
    <div class="grid lg:grid-cols-3 gap-8">
      ...
      <div class="flex flex-col gap-6">
        ...
        <div class="bg-white rounded-2xl border border-[#EEEEEE] shadow-sm p-6">
          <h3 class="font-semibold mb-3 text-[#0A090B]">Materi Terkait</h3>
          <div class="flex flex-col gap-3 text-sm">
            <div class="p-3 bg-[#F9FAFB] rounded-xl hover:bg-gray-50 transition">
              <p class="font-medium text-[#0A090B] truncate">Framework React untuk Aplikasi Modern</p>
              <p class="text-[#7F8190] text-xs">Video • 45 menit</p>
            </div>
            <div class="p-3 bg-[#F9FAFB] rounded-xl hover:bg-gray-50 transition">
              <p class="font-medium text-[#0A090B] truncate">Database dan Backend Development</p>
              <p class="text-[#7F8190] text-xs">PDF • 3.1 MB</p>
            </div>
          </div>
        </div>
      </div>
