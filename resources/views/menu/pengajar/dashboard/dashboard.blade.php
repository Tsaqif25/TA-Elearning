                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <div class="text-center">
                                ...
                                @else
                                    <img src="{{ asset('storage/file/img-upload/' . Auth()->User()->gambar) }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if ($mapelKelasItem['mapel']->gambar != null)
                                        <div class="card-img-full h-100"
                                            style="background-image: url('{{ asset('storage/file/img-upload/' . $mapelKelasItem['mapel']->gambar) }}'); background-size: cover;">
                                        </div>
                                    @else
                                        <div class="card-img-full h-100"
                                                ...
                                                @foreach ($mapelKelasItem['kelas'] as $kelas)
                                                    <div class="col-12">
                                                        <a href="{{ route('viewKelasMapel', [
                                                            'mapel' => $mapelKelasItem['mapel']->id,
                                                            'kelas' => $kelas->id,
                                                        ]) }}"
                                                            class="btn btn-sm btn-primary">
                                                            <i class="fas fa-door-open me-1"></i>{{ $kelas->name }}
                                                        </a>
