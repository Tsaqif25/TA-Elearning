...
class ImportMapel extends Page implements Forms\Contracts\HasForms
{
    ...
    protected static ?string $title = 'Import Data Mapel';
    protected static string $view = 'filament.pages.import-mapel';
    ...
    public function submit()
    {
        ...
        try {
            ...
            // Import Excel
            Excel::import(new MapelImport, $filePath);
            ...
            return redirect()->route('filament.admin.resources.mapels.index');
